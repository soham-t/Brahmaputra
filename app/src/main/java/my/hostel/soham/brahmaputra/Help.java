...
public class Help extends AppCompatActivity {
    ...
    public static final String URL="https://docs.google.com/forms/d/e/1FAIpQLSesEM9TVv2u5cOilLBwuAJSLSE_3ARLdDTn9HHJjnBSRRgOPg/formResponse";
    ...
    public static final String PROB_KEY="entry_1119663091";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        probEditText = (EditText)findViewById(R.id.probEditText);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(roomEditText.getText().toString()) ||
                        ...
                        TextUtils.isEmpty(probEditText.getText().toString()) ||
        ...
        protected Boolean doInBackground(String... contactData) {
            ...
            try {
                ...
                postBody = NAME_KEY+"=" + URLEncoder.encode(name,"UTF-8") +
                        ...
                        "&" + PROB_KEY + "=" + URLEncoder.encode(prob,"UTF-8");
